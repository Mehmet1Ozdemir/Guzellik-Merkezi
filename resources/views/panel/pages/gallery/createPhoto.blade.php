...
@section('content')
    ...
    <div class="content container-fluid">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Fotoğraf Oluştur</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <form method="POST" action="{{ route('panel.galleryCreate') }}" id="createBlogForm" enctype="multipart/form-data">
                    @csrf
                    <!-- Basic Information -->
                    <div class="card">
                        <div class="card-body">
...
{{--                                </div>--}}
                    ...
                    <div class="submit-section submit-btn-bottom">
                        <button type="submit" class="btn btn-primary submit-btn">Create Photo</button>
                    </div>
                </form>
            </div>
        </div>
