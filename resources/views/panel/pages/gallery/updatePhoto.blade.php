...
@section('content')
    ...
    <div class="content container-fluid">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Fotoğraf Güncelleme</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <form method="POST" action="{{ route('panel.galleryUpdate') }}" id="createBlogForm" enctype="multipart/form-data">
                    @csrf
                                    ...
                                    <div class="form-group">
                                        <div class="change-avatar">
                                            <div class="profile-img">
                                                <div class="profile-img">
                                                    <img src="{{$gallery->image}}" alt="User Image">
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <select name="status" class="form-control">
                                                ...
                                                <option value="0" {{ $gallery->status == 0 ? 'selected' : '' }}>Passive</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="submit-section submit-btn-bottom">
                        <button type="submit" class="btn btn-primary submit-btn">Update Photo</button>
                    </div>
                </form>
            </div>
        </div>
